      ...
      >
        <Grid item xs={12} sm={12} md={7} lg={5}>
          ...
          <p className={classes.typo}>
            ...
            building and industrial construction and installation. The company
            invests in the best and latest innovative technological solutions
            available on the market to make things easier and less complicated,
          ...
          <div>
            ...
            <Button
              ...
              href="mailto:damian@guru-utvikling.no"
            >
              Project inquiries
            </Button>
          </div>
